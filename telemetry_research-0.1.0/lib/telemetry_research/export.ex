defmodule TelemetryResearch.Export do
  @moduledoc """
  ...
  alias TelemetryResearch.{Experiment, Store}
  alias TelemetryResearch.Export.{CSV, JSONL}
  ...
  ## Examples
      ...
      # Export to CSV
      {:ok, path} = TelemetryResearch.Export.export("exp-123", :csv,
        path: "results/experiment.csv"
      )

      # Export to JSON Lines
      {:ok, path} = TelemetryResearch.Export.export("exp-123", :jsonl,
